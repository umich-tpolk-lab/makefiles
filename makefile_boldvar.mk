...
MNI=${DATAPATH}/scripts/MNIs/MNI152_T1_2mm_brain.nii.gz
...
${DATAPATH}/designfiles/design_${subject}_${task}.fsf: /nfs/tpolk/mind/boldvariability/placebo/scripts/design_template_${task}.fsf
	...
	sed 's#DATAPATH_dummy#${DATAPATH}#g' -i ${DATAPATH}/designfiles/design_${subject}_${task}.fsf;\
...
registration:${DATAPATH}/preproc/${subject}/${subject}_detrend_filt_denoised_2mm.nii.gz
${DATAPATH}/preproc/${subject}/${subject}_detrend_filt_denoised_2mm.nii.gz:${DATAPATH}/preproc/${subject}/${subject}_detrend_filt_denoised.nii.gz 
...
${DATAPATH}/pls/mean_datamats/${subject}_${task}_meanbold_batch.txt: ${DATAPATH}/preproc/${subject}/preprocess
	cp ${DATAPATH}/scripts/make_batch_template_auditory.txt $@ ;\
...
${DATAPATH}/pls/${subject}_coords_EVAL.mat: ${DATAPATH}/pls/mean_datamats/mean_${subject}_BfMRIsessiondata.mat
	matlab -nosplash -nodesktop -r "try, CommonCoords('${subject}', '${DATAPATH}/preproc/${subject}/${subject}_detrend_filt_denoised_2mm.nii'), catch, 'Error evaluating coords', end; exit" ;\
