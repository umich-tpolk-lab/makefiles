...
preppls: batchfile makemean commoncoords makesd addsdiff
...
${DATAPATH}/preproc/${subject}/addiff:${DATAPATH}/pls/sd_datamats/SD_${subject}_BfMRIsessiondata.mat
	matlab -nosplash -nodesktop -r "try, SDdiff_and_adjusting_sessionInfo('${subject}','${task}','face','house'), catch, 'Error adding sddiff', end; exit" ;\
